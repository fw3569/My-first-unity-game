...
public class ItemSlot : ItemBox,IPointerEnterHandler,IPointerClickHandler,IPointerExitHandler
{
  ...
  public void LoadSlotContent(){
    ...
    if(GameManager.global_data.item_slots!=null&&GameManager.global_data.item_slots.Count>slot_id){
      item_name = GameManager.global_data.item_slots[slot_id];
    }
    if(item_name!=null){
